...
| Lokale Datei | Bekannte Herkunft / Urheber | Lizenzstatus |
| --- | --- | --- |
| `Spritze-mit-Stopfen-small.png` | Projektbestand; Smartfeld | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) |
| `Wasser-mit-Kohlensäure-small.png` | Projektbestand; Urheber nicht dokumentiert | Nicht dokumentiert |
...
| `spritze-aufziehen.gif` | Martin Amberg, Smartfeld | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) |
| `spritze-luft-entfernen.gif` | Martin Amberg, Smartfeld | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) |
| `spritze-verschliessen-blindstopfen.gif` | Martin Amberg, Smartfeld | [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/) |
